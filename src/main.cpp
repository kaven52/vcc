...
int64 nChainStartTime = 1458416120;
...
const string strMessageMagic = "VolcanoCoin signed Message:\n";
...
const int YEARLY_BLOCKCOUNT = 2*525600;	// 365 * 1440*2
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in VolcanoCoin
    bool fStrictPayToScriptHash = true; // Always active in VolcanoCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VolcanoCoin",CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("8be27693941f45604a66e8b055eed176e5ba7e10c5258528d62f676d41748411"));
